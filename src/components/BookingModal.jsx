...
import { X, Zap, Gauge, CheckCircle2, Loader2, User, Mail, Phone, Shield, Car, CreditCard, Lock } from 'lucide-react';
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-zinc-500 text-xs">
                  ...
                  prélevée sur votre carte et remboursée après le retour du véhicule.
                </p>
              </div>
              ...
              <div className="bg-zinc-900/50 border border-white/5 rounded-2xl p-5 space-y-3">
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-black">{totalPrice.toLocaleString('fr-FR')} €</span>
                </div>
                <div className="flex justify-between text-xs border-t border-white/10 pt-3">
                  <span className="text-zinc-500 font-bold uppercase">Caution</span>
              ...
              <div className="space-y-3">
                <button onClick={handlePayDeposit} disabled={isBooking}
                  className="w-full py-5 bg-[#D4AF37] text-black rounded-2xl font-black uppercase text-[10px] tracking-widest hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-50 shadow-lg shadow-[#D4AF37]/20">
