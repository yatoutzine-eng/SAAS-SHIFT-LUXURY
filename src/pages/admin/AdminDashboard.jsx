...
import { 
  ...
  ArrowUpRight, DollarSign, Activity, Globe, Bell
} from 'lucide-react';
...
export default function AdminDashboard({ onLogout }) {
  ...
  const loadStats = async () => {
    try {
      ...
      // Chiffre d'affaires total (réservations terminées + en cours)
      ...
      // Données graphique — revenus par jour sur 7 jours
      ...
      // Actions urgentes depuis les vraies données
      const actions = [];
      // Départs aujourd'hui
      ...
      // Si aucune action réelle, message d'accueil
